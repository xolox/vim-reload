...
function! xolox#reload#misc#escape#pattern(string) " {{{1
...
function! xolox#reload#misc#escape#substitute(string) " {{{1
  " Takes a single string argument and converts it into a [:substitute]
...
function! xolox#reload#misc#escape#shell(string) " {{{1
