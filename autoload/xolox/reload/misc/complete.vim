...
function! xolox#reload#misc#complete#keywords(arglead, cmdline, cursorpos)
  ...
  "
  "     :command -nargs=* -complete=customlist,xolox#reload#misc#complete#keywords MyCmd call s:MyCmd(<f-args>)
  let words = {}
